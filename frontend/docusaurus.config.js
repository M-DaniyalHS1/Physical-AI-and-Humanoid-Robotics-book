// @ts-check
// `@type` JSDoc annotations allow IDEs and type checkers to factory
// about your code and check for errors.
...
const config = {
  title: 'AI-Powered Physical AI & Humanoid Robotics Textbook',
